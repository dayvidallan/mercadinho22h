...
from versailles.apps.base.custom_views import CustomCreateView, CustomUpdateView, CustomTemplateView

from versailles.apps.financeiro.models import PlanoContasGrupo, PlanoContasSubgrupo
from versailles.apps.financeiro.forms import PlanoContasGrupoForm, PlanoContasSubgrupoFormSet
