...
from versailles.apps.vendas.forms import OrcamentoVendaForm, PedidoVendaForm, ItensVendaFormSet, PagamentoFormSet
from versailles.apps.vendas.models import OrcamentoVenda, PedidoVenda, ItensVenda, Pagamento
