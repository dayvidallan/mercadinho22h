...
from versailles.apps.cadastro.models import Pessoa, Cliente, Fornecedor, Transportadora, Produto
from versailles.apps.fiscal.models import ICMS, ICMSSN, IPI, ICMSUFDest
