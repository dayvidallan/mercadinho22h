...
from versailles.apps.cadastro.forms import ProdutoForm, CategoriaForm, UnidadeForm, MarcaForm
from versailles.apps.cadastro.models import Produto, Categoria, Unidade, Marca, Fornecedor
from versailles.apps.estoque.models import ItensMovimento, EntradaEstoque, ProdutoEstocado
