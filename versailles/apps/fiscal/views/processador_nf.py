...
from versailles.apps.fiscal.models import NotaFiscalSaida, NotaFiscalEntrada, ConfiguracaoNotaFiscal, AutXML, \
...
from versailles.apps.cadastro.models import COD_UF, PessoaJuridica, PessoaFisica, Fornecedor, Cliente, Empresa, Transportadora, Endereco, Telefone, Produto, Unidade
from versailles.apps.compras.models import PedidoCompra, ItensCompra
from versailles.apps.vendas.models import PedidoVenda, ItensVenda

from versailles.apps.vendas.models import Pagamento as PagamentoVenda
