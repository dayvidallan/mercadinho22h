...
from versailles.apps.base.custom_views import CustomCreateView, CustomListView, CustomUpdateView

from versailles.apps.fiscal.forms import GrupoFiscalForm, ICMSForm, ICMSSNForm, ICMSUFDestForm, IPIForm, PISForm, COFINSForm
from versailles.apps.fiscal.models import GrupoFiscal, ICMS, ICMSSN, ICMSUFDest, IPI
