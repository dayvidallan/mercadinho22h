...
from versailles.apps.cadastro.models import Cliente, Fornecedor, Produto, Empresa, Transportadora
from versailles.apps.vendas.models import OrcamentoVenda, PedidoVenda
from versailles.apps.compras.models import OrcamentoCompra, PedidoCompra
from versailles.apps.financeiro.models import MovimentoCaixa, Entrada, Saida
