...
from versailles.apps.compras.models import ItensCompra, Pagamento
from versailles.apps.vendas.views.report_vendas import VendaReport, REPORT_FONT_BOLD, REPORT_FONT, DadosProdutos, DadosPagamento
