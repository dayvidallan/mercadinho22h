...
from versailles.apps.base.custom_views import CustomView, CustomCreateView, CustomListView, CustomUpdateView

from versailles.apps.compras.forms import OrcamentoCompraForm, PedidoCompraForm, ItensCompraFormSet, PagamentoFormSet
from versailles.apps.compras.models import OrcamentoCompra, PedidoCompra, ItensCompra, Pagamento
from versailles.apps.cadastro.models import MinhaEmpresa
from versailles.apps.estoque.models import ProdutoEstocado, EntradaEstoque, ItensMovimento
from versailles.apps.login.models import Usuario
from versailles.configs.settings import MEDIA_ROOT
