...
from versailles.tests.test_case import BaseTestCase, replace_none_values_in_dictionary
from versailles.apps.cadastro.models import Fornecedor, Produto
from versailles.apps.compras.models import OrcamentoCompra, PedidoCompra, ItensCompra
from versailles.apps.estoque.models import LocalEstoque, DEFAULT_LOCAL_ID
