...
from versailles.tests.test_case import BaseTestCase
from versailles.apps.cadastro.models import Cliente
from versailles.apps.vendas.models import CondicaoPagamento, OrcamentoVenda, PedidoVenda
