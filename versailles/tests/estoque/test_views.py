...
from versailles.apps.cadastro.models import Produto
from versailles.apps.estoque.models import LocalEstoque, DEFAULT_LOCAL_ID, ProdutoEstocado, EntradaEstoque, SaidaEstoque, TransferenciaEstoque
